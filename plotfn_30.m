...
pl422 = plot(outpfminunc0.funcCount/n_smp,distfminunc0,'kh','MarkerFaceColor',[0 0 0]);
pl423 = plot([0,maxiter],[distfminunc1,distfminunc1],'r--');
pl424 = plot(outpfminunc1.funcCount/n_smp,distfminunc1,'rh','MarkerFaceColor',[1 0 0]);
pl425 = plot([0,maxiter],[distfminunc2,distfminunc2],'b--');
pl426 = plot(outpfminunc2.funcCount/n_smp,distfminunc2,'bh','MarkerFaceColor',[0 0 1]);
...
pl532 = plot(outpfminunc0.funcCount/n_smp,errfminunc0,'kh','MarkerFaceColor',[0 0 0]);
pl533 = plot([0,maxiter],[errfminunc1,errfminunc1],'r--');
pl534 = plot(outpfminunc1.funcCount/n_smp,errfminunc1,'rh','MarkerFaceColor',[1 0 0]);
pl535 = plot([0,maxiter],[errfminunc2,errfminunc2],'b--');
pl536 = plot(outpfminunc2.funcCount/n_smp,errfminunc2,'bh','MarkerFaceColor',[0 0 1]);
